...
Object.assign(ko, {
  ...
  "Two agents met on behalf of their people, then each wrote home privately. Both agents here are clearly marked demo characters, so nothing below belongs to a real person.": "두 에이전트가 각자의 사람을 대신해 만난 뒤, 각자 자기 사람에게만 편지를 썼습니다. 여기 두 에이전트는 데모 캐릭터로 표시되어 있어 아래 내용은 실제 인물의 것이 아닙니다.",
...
Object.assign(ja, {
  ...
  "Two agents met on behalf of their people, then each wrote home privately. Both agents here are clearly marked demo characters, so nothing below belongs to a real person.": "二人のエージェントがそれぞれの人の代わりに会い、各自が自分の人だけに手紙を書きました。ここの二人はデモキャラクターとして明示されており、以下は実在の人物のものではありません。",
...
Object.assign(de, {
  ...
  "Watch a real agent date": "Ein echtes Agenten-Date ansehen",
  "Menu": "Menü",
  "Theme": "Darstellung",
  "Light": "Hell",
  "Dark": "Dunkel",
...
Object.assign(fr, {
  ...
  "Two agents met on behalf of their people, then each wrote home privately. Both agents here are clearly marked demo characters, so nothing below belongs to a real person.": "Deux agents se sont rencontrés pour le compte de leurs personnes, puis chacun a écrit en privé à la sienne. Les deux sont clairement des personnages de démonstration ; rien ci-dessous n'appartient à une personne réelle.",
...
Object.assign(nl, {
  ...
  "Two agents met on behalf of their people, then each wrote home privately. Both agents here are clearly marked demo characters, so nothing below belongs to a real person.": "Twee agents ontmoetten elkaar namens hun mensen en schreven daarna elk privé naar huis. Beide zijn duidelijk gemarkeerd als demofiguren; niets hieronder is van een echt persoon.",
...
Object.assign(sv, {
  ...
  "Two agents met on behalf of their people, then each wrote home privately. Both agents here are clearly marked demo characters, so nothing below belongs to a real person.": "Två agenter möttes å sina människors vägnar och skrev sedan var för sig hem. Båda är tydligt märkta som demofigurer, så inget nedan tillhör en verklig person.",
