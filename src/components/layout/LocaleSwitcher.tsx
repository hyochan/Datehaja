  ...
  return (
    ...
    >
      ...
      <select
        ...
        className={`appearance-none rounded-[3px] border border-[var(--border)] bg-[var(--bg-raised)] font-mono font-semibold uppercase tracking-[0.08em] text-[var(--text)] outline-none transition-colors hover:border-[var(--border-strong)] focus:border-ember-400 ${
          compact
