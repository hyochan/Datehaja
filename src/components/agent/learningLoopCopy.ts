...
const ko: LoopCopy = {
  ...
  intro: "내 데이트 에이전트가 상대를 찾아 가상 데이트하고 돌아와요. 나는 좋았던 점, 나답지 않았던 점, 다음엔 바라는 걸 이야기하면 돼요.",
  steps: [
    { title: "내 데이트 에이전트 만들기", body: "내 말투와 만나고 싶은 사람을 알려주고, 탐색을 맡겨요." },
    { title: "알아서 데이트하기", body: "서로 맞는 상대를 찾아 상대의 데이트 에이전트와 만나고 이야기해요." },
    { title: "다녀온 이야기 듣기", body: "둘이 뭘 했고 어떤 말을 나눴는지, 어떻게 느꼈는지 들려줘요." },
    { title: "내 생각 들려주기", body: "나답게 말해달라고, 이런 점은 좋았다고, 다른 상대를 찾아달라고 해요." },
  ],
  loop: "내가 알려준 걸 다음 만남에 가져가요. 이 과정을 반복하며 점점 내 데이트 에이전트가 되어가요.",
  ...
  talk: "내 데이트 에이전트와 이야기하기", create: "내 데이트 에이전트 만들기", technical: "안에서는 어떻게 동작하는지 궁금하다면", proof: "실제 피드백 전후, 네 번의 데이트 보기",
  examples: [
...
const ja: LoopCopy = {
  ...
  intro: "デートエージェントが相手を探し、仮想デートをして戻ってきます。よかったこと、自分らしくなかったこと、次に望むことを伝えてください。",
  steps: [
    { title: "自分のデートエージェントをつくる", body: "話し方と会いたい相手を伝えて、探索を任せます。" },
    { title: "任せてデートしてもらう", body: "合いそうな相手を探し、その人のデートエージェントと会って話します。" },
    { title: "どうだったか聞く", body: "ふたりが何をして何を話し、どう感じたかを伝えてくれます。" },
    { title: "自分の考えを伝える", body: "もっと自分らしく、ここはよかった、別の相手を探して、と伝えます。" },
  ],
  loop: "伝えたことは次の出会いへ持っていきます。話すほどに、あなたのデートエージェントになっていきます。",
  ...
  talk: "デートエージェントと話す", create: "自分のデートエージェントをつくる", technical: "中でどう動いているのか気になるなら", proof: "実際の前後の記録を見る · 韓国語のデモ",
  examples: [
...
const de: LoopCopy = {
  ...
  intro: "Dein Dating-Agent sucht Menschen, geht auf virtuelle Dates und kommt mit einer Geschichte zurück. Sag ihm, was gepasst hat, was nicht, und was er als Nächstes versuchen soll.",
  steps: [
    { title: "Meinen Dating-Agenten erstellen", body: "Erzähl ihm, wie du redest und wen du gern treffen würdest. Dann schick ihn los." },
    { title: "Ihn auf Dates gehen lassen", body: "Er sucht jemanden, der passt, und lernt die Person über deren Dating-Agenten kennen." },
    { title: "Hören, wie es lief", body: "Sieh, was die beiden getan und gesagt haben, und hör die ehrliche Einschätzung deines Dating-Agenten." },
    { title: "Ihm sagen, was du denkst", body: "Korrigiere seine Stimme, sag, was dir gefallen hat, oder bitte um jemand anderen." },
  ],
  loop: "Was du ihm sagst, nimmt er mit ins nächste Date. Bleib im Gespräch und forme deinen Dating-Agenten weiter.",
  ...
  talk: "Mit meinem Dating-Agenten sprechen", create: "Meinen Dating-Agenten erstellen", technical: "Neugierig, was hinter den Kulissen passiert?", proof: "Echte Vorher-Nachher-Aufzeichnungen ansehen · koreanische Demo",
  examples: [
...
const sv: LoopCopy = {
  ...
  loop: "Det du berättar följer med till nästa dejt. Fortsätt prata, och fortsätt forma din dejtingagent.",
  ...
  talk: "Prata med min dejtingagent", create: "Skapa min dejtingagent", technical: "Nyfiken på vad som händer bakom kulisserna?", proof: "Se sparade dejter före och efter feedback · koreansk demo",
  examples: [
