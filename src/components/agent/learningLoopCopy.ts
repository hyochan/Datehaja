...
const de: LoopCopy = {
  ...
  intro: "Dein Agent sucht Menschen, geht auf virtuelle Dates und kommt mit einer Geschichte zurück. Sag ihm, was gepasst hat, was nicht, und was es als Nächstes versuchen soll.",
  steps: [
    { title: "Meinen Dating-Agenten erstellen", body: "Erzähl, wie du sprichst und wen du treffen möchtest. Dann schick deinen Agenten los." },
  ...
  loop: "Was du ihm sagst, kommt beim nächsten Date mit. Sprich weiter, und forme deinen Agenten weiter.",
  ...
  youSay: "Du sagst", yourAgent: "Dein KI-Agent", carriesForward: "Was er ins nächste Date mitnimmt", exampleNote: "Beispiele dafür, wie Feedback weiterwirken kann. Änderungen an den Suchoptionen bestätigen wir mit dir.",
  waiting: "Wenn er noch niemanden gefunden hat, sucht er weiter. Schau vorbei, wann du magst.", consent: "Sich wirklich zu treffen, ist immer die Entscheidung beider.",
  ...
  examples: [
    { label: "Klingt mehr nach mir", feedback: "So eine Rede würde ich nicht halten. Fass dich kürzer und beende nicht jede Antwort mit einer Frage.", memory: "Kurze, natürliche Antworten. Lass der anderen Person Raum.", nextLabel: "So ließe es sich nächstes Mal sagen", next: "„Geht mir genauso. Ich lasse uns lieber Zeit.“" },
...
const sv: LoopCopy = {
  ...
  steps: [
    ...
    { title: "Säg vad du tycker", body: "Justera dess röst, peka ut vad du gillade, eller be den leta efter någon annan." },
  ],
  loop: "Det du berättar följer med till nästa dejt. Fortsätt prata, och fortsätt forma din agent.",
  exampleLabel: "Lite återkoppling räcker långt", exampleTitle: "”Så där låter det mer som jag.”", chooseExample: "Se ett exempel på återkoppling",
  youSay: "Du säger", yourAgent: "Din AI-agent", carriesForward: "Det den tar med till nästa dejt", exampleNote: "Exempel på hur återkoppling kan följa med. Ändringar i sökinställningarna bekräftar vi med dig.",
  ...
  examples: [
    { label: "Låt mer som jag", feedback: "Jag skulle inte hålla ett sådant tal. Håll det kortare, och avsluta inte varje svar med en fråga.", memory: "Korta, naturliga svar. Lämna plats åt den andra.", nextLabel: "Så skulle det kunna sägas nästa gång", next: "”Samma här. Jag tar hellre tid på oss.”" },
    { label: "Ändra vad jag söker", feedback: "Jag gillar någon som är nyfiken på mig också. Leta efter någon som frågar tillbaka.", memory: "Lägg märke till ömsesidig nyfikenhet, inte bara ett lättsamt samtal.", nextLabel: "Att lägga märke till vid nästa möte", next: "Tar personen fasta på ett svar och vill veta mer? Går nyfikenheten åt båda håll?" },
