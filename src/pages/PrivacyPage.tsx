...
import { Card, Chip, SectionHeading, Skeleton, Tag } from "../components/ui/primitives";
...
export default function PrivacyPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8">
          ...
          <section>
            ...
            <Card className="p-5">
              <div className="text-[18px] font-medium">
                {visibility.beforeMatch.displayName} · {visibility.beforeMatch.age}
              </div>
      ...
      <section>
        <SectionHeading eyebrow="How it works" title="Why the email comes from us" />
        <Card className="p-5">
          <p className="text-[15px] leading-relaxed">
            Every invitation, confirmation and reminder is sent by{" "}
            <strong className="font-medium">DateDrop Concierge</strong> from our own
            inbox. Your address is the recipient, never the sender, and never a CC.
            Two people on the same DateDrop are always emailed separately, so
            neither can see the other's address in a header.
          </p>
          <p className="mt-3 text-[15px] leading-relaxed">
            If you reply to one of those emails, it comes back to us — not to your
            match.
          </p>
        </Card>
      </section>
      ...
      <section>
        <SectionHeading eyebrow="Location" title="How precise your location is" />
        <Card className="p-5">
          <p className="text-[15px] leading-relaxed">
            You pick a neighbourhood, not an address. We store the neighbourhood's
            approximate centre rounded to about a kilometre, and use it only to
            work out roughly where a date should happen. Your match sees the
            neighbourhood name and nothing more precise — never a distance in
            kilometres, because a distance plus a map inverts to a location.
          </p>
        </Card>
      </section>
      ...
      <section>
        ...
        <Card className="p-5">
          <p className="text-[15px] leading-relaxed">
            Bios and notes are scrubbed for email addresses, phone numbers, links
            and messenger handles before anyone else can read them. It isn't that
            we don't trust you — it's that the product only works if nobody feels
            pressure to hand over contact details before they've met.
          </p>
        </Card>
      </section>
      ...
      <section>
        ...
        <Card className="p-5">
          ...
          <p className="text-[15px] leading-relaxed">
            DateDrop does <strong className="font-medium">not</strong> verify anyone's
            identity. There is no ID check, no photo verification, and no background
            check. Please treat every match as someone you met on the internet, and
            read the{" "}
