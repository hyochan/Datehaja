  ...
  return (
    <div className="product-page mx-auto max-w-3xl space-y-10">
      <PageIntro
        eyebrow="Demo mode"
        title="Demo controls"
        description="Meet the fictional cast, play both sides, and watch one plan travel from a free evening to a confirmed date."
        motif="D"
        tone="lilac"
      />
      ...
      <Notice tone="info" title="These people are not real">
        ...
        everywhere they appear, they never receive email, and you can switch
        them off entirely in{" "}
        ...
        {board === undefined ? (
          ...
          <Card className="p-5">
            <p className="text-[15px] leading-relaxed text-soft">
              Nothing to respond to yet. Accept a date with a demo profile first
              — then come back here and play their side.
            </p>
            <div className="mt-4">
              <Link
                to="/dashboard"
      ...
      <section>
        <SectionHeading
          eyebrow="For judges"
          title="The 60-second run-through"
        />
        <Card className="p-5">
          <ol className="space-y-2.5 text-[15px] leading-relaxed">
            {[
              "Add a time and the date you actually want — for example, an indie film with no second stop.",
              "Hit “Find someone to go with” on the dashboard and watch the stages advance — each one is a real Convex document update, not a timer.",
